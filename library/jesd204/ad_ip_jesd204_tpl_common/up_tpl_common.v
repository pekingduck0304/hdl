...
module up_tpl_common #(
  ...
  parameter PNUM = 1           // Number of JESD profiles
  )(
  ...
  output reg [$clog2(PNUM):0] up_profile_sel = 'h0,
  ...
  always @(negedge up_rstn or posedge up_clk) begin
    if (up_rstn == 0) begin
      ...
      if ((up_wreq_s == 1'b1) && (up_waddr[7:0] == 8'h00)) begin
        up_profile_sel <= up_wdata[$clog2(PNUM):0];
      end
    end
  end
  ...
  integer i;
  always @(*) begin
    for (i=0; i<PNUM; i = i + 1) begin:jesd_param
