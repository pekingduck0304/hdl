...
reg [(DATA_WIDTH):0] data_sdo_shift = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_1 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_2 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_3 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_4 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_5 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_6 = 'h0;
reg [(DATA_WIDTH):0] data_sdi_shift_7 = 'h0;
...
assign sdo = ((inst_d1 == CMD_TRANSFER) && (sdo_enabled)) ? data_sdo_shift[DATA_WIDTH] : SDO_DEFAULT;
...
always @(posedge clk) begin
  if (trigger_rx_s == 1'b1) begin
    data_sdi_shift <= {data_sdi_shift[(DATA_WIDTH-1):0], sdi};
    data_sdi_shift_1 <= {data_sdi_shift_1[(DATA_WIDTH-1):0], sdi_1};
    data_sdi_shift_2 <= {data_sdi_shift_2[(DATA_WIDTH-1):0], sdi_2};
    data_sdi_shift_3 <= {data_sdi_shift_3[(DATA_WIDTH-1):0], sdi_3};
    data_sdi_shift_4 <= {data_sdi_shift_4[(DATA_WIDTH-1):0], sdi_4};
    data_sdi_shift_5 <= {data_sdi_shift_5[(DATA_WIDTH-1):0], sdi_5};
    data_sdi_shift_6 <= {data_sdi_shift_6[(DATA_WIDTH-1):0], sdi_6};
    data_sdi_shift_7 <= {data_sdi_shift_7[(DATA_WIDTH-1):0], sdi_7};
  end
end

assign sdi_data = (NUM_OF_SDI == 1) ? data_sdi_shift[(DATA_WIDTH-1):0] :
                  (NUM_OF_SDI == 2) ? {data_sdi_shift_1[(DATA_WIDTH-1):0], data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 3) ? {data_sdi_shift_2[(DATA_WIDTH-1):0], data_sdi_shift_1[(DATA_WIDTH-1):0],
                                                                       data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 4) ? {data_sdi_shift_3[(DATA_WIDTH-1):0], data_sdi_shift_2[(DATA_WIDTH-1):0],
                                       data_sdi_shift_1[(DATA_WIDTH-1):0], data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 5) ? {data_sdi_shift_4[(DATA_WIDTH-1):0], data_sdi_shift_3[(DATA_WIDTH-1):0],
                                       data_sdi_shift_2[(DATA_WIDTH-1):0], data_sdi_shift_1[(DATA_WIDTH-1):0],
                                                                       data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 6) ? {data_sdi_shift_5[(DATA_WIDTH-1):0], data_sdi_shift_4[(DATA_WIDTH-1):0],
                                       data_sdi_shift_3[(DATA_WIDTH-1):0], data_sdi_shift_2[(DATA_WIDTH-1):0],
                                       data_sdi_shift_1[(DATA_WIDTH-1):0], data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 7) ? {data_sdi_shift_6[(DATA_WIDTH-1):0], data_sdi_shift_5[(DATA_WIDTH-1):0],
                                       data_sdi_shift_4[(DATA_WIDTH-1):0], data_sdi_shift_3[(DATA_WIDTH-1):0],
                                       data_sdi_shift_2[(DATA_WIDTH-1):0], data_sdi_shift_1[(DATA_WIDTH-1):0],
                                                                       data_sdi_shift[(DATA_WIDTH-1):0]} :
                  (NUM_OF_SDI == 8) ? {data_sdi_shift_7[(DATA_WIDTH-1):0], data_sdi_shift_6[(DATA_WIDTH-1):0],
                                       data_sdi_shift_5[(DATA_WIDTH-1):0], data_sdi_shift_4[(DATA_WIDTH-1):0],
                                       data_sdi_shift_3[(DATA_WIDTH-1):0], data_sdi_shift_2[(DATA_WIDTH-1):0],
                                       data_sdi_shift_1[(DATA_WIDTH-1):0], data_sdi_shift[(DATA_WIDTH-1):0]} :
                  data_sdi_shift[7:0];
